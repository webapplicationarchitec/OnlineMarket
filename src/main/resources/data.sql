...
values (1,'Beats by Dr. Dre Wireless Headphones','Headphones','/assets/images/demos/demo-4/products/product-10.jpg','30',279.99,1,3,'luannguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`sellerid`)
values (2,'GoPro - HERO7 Black HD Waterproof Action','Cameras & Camcorders','/assets/images/demos/demo-4/products/product-11.jpg','10',349.99,1,2,'luannguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`sellerid`)
values (3,'Apple - Apple Watch Series 3 with White Sport Band','Smartwatches','/assets/images/demos/demo-4/products/product-12.jpg','11',214.49,1,6,'hanguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`sellerid`)
values (4,'Lenovo - 330-15IKBR 15.6"','Smartwatches','/assets/images/demos/demo-4/products/product-13.jpg',12,339.99,1,1,'hanguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`sellerid`)
values (5,'Sony - Alpha a5100 Mirrorless Camera','Digital Cameras','/assets/images/demos/demo-4/products/product-14.jpg','15',499.99,1,2,'yenpham');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`sellerid`)
values (6,'Home Mini - Smart Speaker with Google Assistant','Audio','/assets/images/demos/demo-4/products/product-15.jpg','10',49.00,1,5,'yenpham');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`sellerid`)
values (7,'WONDERBOOM Portable Bluetooth Speaker','Audio','/assets/images/demos/demo-4/products/product-16.jpg','9',99.99,1,5,'hainguyen');


insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`sellerid`)
values (8,'Google - Home Hub with Google Assistant','Smart Home','/assets/images/demos/demo-4/products/product-17.jpg','2',149.00,1,4,'hainguyen');
