...
values (100,'Beats by Dr. Dre Wireless Headphones','Headphones','http://localhost:8080/assets/images/demos/demo-4/products/product-10.jpg','30',279.99,1,3,'luannguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`seller_id`)
values (102,'GoPro - HERO7 Black HD Waterproof Action','Cameras & Camcorders','http://localhost:8080/assets/images/demos/demo-4/products/product-11.jpg','10',349.99,1,2,'luannguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`seller_id`)
values (103,'Apple - Apple Watch Series 3 with White Sport Band','Smartwatches','http://localhost:8080/assets/images/demos/demo-4/products/product-12.jpg','11',214.49,1,6,'luannguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`seller_id`)
values (104,'Lenovo - 330-15IKBR 15.6"','Smartwatches','http://localhost:8080/assets/images/demos/demo-4/products/product-13.jpg',12,339.99,1,1,'luannguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`seller_id`)
values (105,'Sony - Alpha a5100 Mirrorless Camera','Digital Cameras','http://localhost:8080/assets/images/demos/demo-4/products/product-14.jpg','15',499.99,1,2,'hainguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`seller_id`)
values (106,'Home Mini - Smart Speaker with Google Assistant','Audio','http://localhost:8080/assets/images/demos/demo-4/products/product-15.jpg','10',49.00,1,5,'hainguyen');

insert into product(`Id`,`description`,`name`,`photo`,`point`,`price`,`status`,`category_id`,`seller_id`)
values (107,'WONDERBOOM Portable Bluetooth Speaker','Audio','http://localhost:8080/assets/images/demos/demo-4/products/product-16.jpg','9',99.99,1,5,'hainguyen');
...
values  (201,'2020-05-12 12:38:00','2020-05-12 12:38:00','2020-05-12 12:38:00','123IO',106,'1000N 4th Street, Fairfield, IA',23,1,12,50,'hanguyen');

insert into online_order(`Id`,`date_create`,`date_delivered`,`date_shipping`,`orderno`,`point`,`shipping_address`,`shipping_fee`,`status`,`tax`,`total`,`buyer_id`)
values  (202,'2020-05-13 12:38:00','2020-05-12 12:38:00','2020-05-12 12:38:00','123IO',106,'1000N 4th Street, Fairfield, CA',23,2,12,50,'hanguyen');
